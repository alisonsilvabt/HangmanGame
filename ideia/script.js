...
var palavras = [
    { palavra: "BOLA", dica: "Objeto esférico usado em diversos esportes" },
    { palavra: "CARRO", dica: "Veículo de quatro rodas usado para transporte" },
    { palavra: "CASA", dica: "Habitação comum feita de tijolos, madeira, etc." },
    { palavra: "BANANA", dica: "Fruta amarela e doce com formato alongado" },
    { palavra: "MESA", dica: "Móvel com tampo plano e suportes para sustentá-lo" },
    { palavra: "GATO", dica: "Animal doméstico de estimação com pelos macios" },
    { palavra: "ABACAXI", dica: "Fruta tropical com casca dura e polpa doce" }
];
...
function verificarAdivinhacao() {
    ...
    if (tentativasRestantes === 0) {
        ...
        reiniciarJogo();
    } else if (letrasCorretas.length === palavraEscolhida.length) {
        winSound.play();
        alert("Parabéns, você acertou a palavra " + palavraEscolhida + "!");
        reiniciarJogo();
    }
